...
<div class="container">
    <div class="card">
        <div class="card-header">
            <h2>Crear Nuevo Registro Histórico</h2>
        </div>
        <div class="card-body">
            @if ($errors->any())
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="datetime-local" class="form-control @error('fecha_salida') is-invalid @enderror" 
                                   name="fecha_salida" id="fecha_salida" value="{{ old('fecha_salida') }}">
                            @error('fecha_salida')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            ...
                            <select class="form-select @error('id_estatus') is-invalid @enderror" 
                                ...
                                @foreach($estatus as $estatu)
                                    <option value="{{ $estatu->id }}" {{ old('id_estatus') == $estatu->id ? 'selected' : '' }}>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea class="form-control @error('comentarios') is-invalid @enderror" 
                                      ...
                                      placeholder="Ingrese los comentarios relevantes">{{ old('comentarios') }}</textarea>
                            @error('comentarios')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
