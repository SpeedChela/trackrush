    ...
    <article class="post">
      <header>
        <div class="title">
          ...
          <ul class="actions">
            <li><a href="{{ route('historico.create') }}" class="btn btn-primary btn-lg">Nuevo {{ $singular }}</a></li>
          </ul>
        </div>
      </header>
      <section>
            ...
            <tbody>
              @foreach($registros as $registro)
                <tr>
                  ...
                  <td>
                    <a href="{{ route('historico.read', $registro->id) }}" class="btn btn-info btn-sm">Detalle</a>
                    <a href="{{ route('historico.edit', $registro->id) }}" class="btn btn-warning btn-sm">Editar</a>
