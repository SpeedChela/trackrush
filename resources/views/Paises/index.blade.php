    ...
    <article class="post">
      <header>
        <div class="title">
          ...
          <ul class="actions">
            <li><a href="{{ route('paises.create') }}" class="btn btn-primary btn-lg">Nuevo {{ $singular }}</a></li>
          </ul>
        </div>
      </header>
      <section>
            ...
            <tbody>
              @foreach($registros as $registro)
                <tr>
                  ...
                  <td>
                    <a href="{{ route('paises.read', $registro->id) }}" class="btn btn-info btn-sm">Detalle</a>
