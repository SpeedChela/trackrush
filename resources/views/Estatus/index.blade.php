    ...
    <article class="post">
      <header>
        <div class="title">
          ...
          <ul class="actions">
            <li><a href="{{ route('estatus.create') }}" class="btn btn-primary btn-lg">Nuevo {{ $singular }}</a></li>
          </ul>
        </div>
      </header>
      <section>
            ...
            <tbody>
              @foreach($registros as $registro)
                <tr>
                  ...
                  <td>{{ $registro->devuelto }}</td>
                  <td>
                    <a href="{{ route('estatus.read', $registro->id) }}" class="btn btn-info btn-sm">Detalle</a>
                    <a href="{{ route('estatus.edit', $registro->id) }}" class="btn btn-warning btn-sm">Editar</a>
